...
typetest.isNumber = function isNumber(value) {
...
typetest.isInt = function isInt(value) {
...
typetest.isUint = function isUint(value) {
  return typetest.isInt(value) && value >= 0;
};
...
typetest.isFloat = function isFloat(value) {
...
typetest.isUfloat = function isUfloat(value) {
  return typetest.isFloat(value) && value >= 0;
};
...
typetest.isI8 = function isI8(value) {
...
typetest.isI16 = function isI16(value) {
...
typetest.isI32 = function isI32(value) {
...
typetest.isI64 = function isI64(value) {
  return typetest.isInt(value);
};
...
typetest.isU8 = function isU8(value) {
...
typetest.isU16 = function isU16(value) {
...
typetest.isU32 = function isU32(value) {
  return (value >>> 0) === value;
};
...
typetest.isU64 = function isU64(value) {
  return typetest.isUint(value);
};
...
typetest.isAscii = function isAscii(str) {
...
typetest.isBase58 = function isBase58(str) {
...
typetest.isBech32 = function isBech32(str) {
...
typetest.isHex = function isHex(str) {
  if (typeof str !== 'string')
    return false;
...
typetest.isHex160 = function isHex160(hash) {
  if (typeof hash !== 'string')
    return false;
  return hash.length === 40 && typetest.isHex(hash);
};
...
typetest.isHex256 = function isHex256(hash) {
  if (typeof hash !== 'string')
    return false;
  return hash.length === 64 && typetest.isHex(hash);
};
...
typetest.isSafeAddition = function isSafeAddition(a, b) {
